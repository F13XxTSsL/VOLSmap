  ...
  export default {
    data() {
      return {
        ...
        headers: [
          {text: 'Номер объекта', sortable: false, value: 'id_object', class: 'id_cell', align: 'center'},
          {text: 'Тип объекта', sortable: false, value: 'type', class: 'type', align: 'center'},
          {text: 'Имя объекта', value: 'name_obj', sortable: false, class: 'name_partner', align: 'center'},
          {
          ...
          {text: 'Номер договора', value: 'id_obj_contract', sortable: false, class: 'id_cell', align: 'center'},
          {text: 'Арендная плата', value: 'rent', sortable: false, class: 'rent_cell', align: 'center'},
          {text: 'Адрес', value: 'adress', sortable: false, class: 'adress', align: 'center'},
          ...
          {text: 'Координаты', sortable: false, value: 'coordinates', class: 'coords', align: 'center'},
